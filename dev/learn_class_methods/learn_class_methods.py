...
class CustomLogger:
    ...
    def init_metadata(cls, str_to_append: str = str_to_append, cl_to_append: str = cl_to_append):
        """
        fake metaclass?
    ...
    def __init__(self):
        ...
        self.init_metadata(self.str_to_append, self.cl_to_append)
